(function () {
    console.log('≡ƒöº Gistav engine.js v2 loaded!');
            ...
            try {
                ...
                if (obj && typeof obj === 'object') {
                    if (typeof obj.containerPointToLatLng === 'function' && 
                        ...
                        cachedMap = obj;
                        console.log('Γ£à Gistav: Map found in memory under window.' + key);
                        return cachedMap;
                    }
    ...
    function addMarkerNow(detail) {
        ...
        try {
            ...
            // gives coordinates IN that pane's own coordinate system ΓÇö so it's always correct.
            ...
            console.log('Γ£à Gistav marker pinned:', id);
            return true;
        } catch (err) {
    ...
    const readyInterval = setInterval(() => {
        ...
        if (map) {
            ...
            console.log('Γ£à Gistav: Map found! Flushing queue:', pendingQueue.length, 'items');
